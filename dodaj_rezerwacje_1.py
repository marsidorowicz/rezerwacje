...
#    Jun 20, 2020 10:10:31 AM CEST  platform: Windows NT
...
import dodaj_rezerwacje_1_support
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    dodaj_rezerwacje_1_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    dodaj_rezerwacje_1_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Reservation.configure(text='''Zapisz''')
