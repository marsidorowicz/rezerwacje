...
if __name__ == '__main__':
    try:
        ...
        from tkinter import Tk, Label, Frame, Listbox
    ...
    scrolling_area.pack(expand=True, fill="both")
    ...
    lb = {}
    for i in range(x):
        listbox = Listbox(scrolling_area.innerframe, width=14, relief="sunken", height=1000)
